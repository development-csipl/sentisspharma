 ...
 * @since 1.0.0
 */
class Inzox_Icon_Controler extends Elementor\Base_Data_Control {
	...
	public static function get_icons() {
		...
		$icons = array(
                  ...
                  'icon icon-feature_icon11' => 'icon icon-feature_icon11',
                  'icon icon-feature_icon1' => 'icon icon-feature_icon1',
                  'icon icon-feature_icon21' => 'icon icon-feature_icon21',
                  'icon icon-feature_icon2' => 'icon icon-feature_icon2',
                  'icon icon-feature_icon31' => 'icon icon-feature_icon31',
                  'icon icon-feature_icon3' => 'icon icon-feature_icon3',
                  'icon icon-funfact_icon1' => 'icon icon-funfact_icon1',
                  'icon icon-funfact_icon2' => 'icon icon-funfact_icon2',
                  'icon icon-funfact_icon3' => 'icon icon-funfact_icon3',
                  'icon icon-menu_icon1' => 'icon icon-menu_icon1',
                  'icon icon-menu_icon2' => 'icon icon-menu_icon2',
                  'icon icon-menu_icon3' => 'icon icon-menu_icon3',
                  'icon icon-menu_icon4' => 'icon icon-menu_icon4',
                  'icon icon-menu_icon5' => 'icon icon-menu_icon5',
                  ...
                  'icon icon-quote11' => 'icon icon-quote11',
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				...
				<select class="elementor-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php esc_attr_e( 'Select Icon', 'inzox' ); ?>">

					<option value=""><?php esc_html_e( 'Select Icon', 'inzox' ); ?></option>
