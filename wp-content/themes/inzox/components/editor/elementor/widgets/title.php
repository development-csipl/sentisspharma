...
class Inzox_Title_Widget extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_tab',
            [
                'label' => esc_html__('Title settings', 'inzox'),
            ]
        );
        ...
        $this->add_control(
         'title_style',
         [
            'label' => esc_html__( 'Title style', 'inzox' ),
            'type' => Custom_Controls_Manager::IMAGECHOOSE,
            'default' => 'style1',
            'options' => [
               'style1'  => [
                  'title' => esc_html__( 'Style 1', 'inzox' ),
                        'imagelarge' => INZOX_IMG. '/admin/title/style1.png',
                        'imagesmall' => INZOX_IMG. '/admin/title/style1.png',
                        'width' => '30%',
               ],
               'style2'  => [
                  'title' => esc_html__( 'Style 2', 'inzox' ),
                        'imagelarge' => INZOX_IMG. '/admin/title/style2.png',
                        'imagesmall' => INZOX_IMG. '/admin/title/style2.png',
                        'width' => '30%',
               ],
               'style3'  => [
                  'title' => esc_html__( 'Style 3', 'inzox' ),
                        'imagelarge' => INZOX_IMG. '/admin/title/style3.png',
                        'imagesmall' => INZOX_IMG. '/admin/title/style3.png',
                        'width' => '30%',
               ],
		...
		$this->add_control(
			'title', [
				'label'			=> esc_html__( 'Heading Title', 'inzox' ),
				'type'			=> Controls_Manager::TEXTAREA,
				'label_block'	=> true,
				'placeholder'	=> esc_html__( 'Breakfast', 'inzox' ),
				'default'	     => esc_html__( 'why {choose} us', 'inzox' ),
			]
		);
      ...
      [
      'label'       => esc_html__('Show title border', 'inzox'),
      ...
      $this->add_responsive_control(
			'title_align', [
				...
				'options'		 => [
					...
					'justify'	 => [
						'title'	 => esc_html__( 'Justified', 'inzox' ),
      ...
      $this->start_controls_section(
			'section_title_border_style', [
				'label'	 => esc_html__( 'Title border', 'inzox' ),
            'tab'	 => Controls_Manager::TAB_STYLE,
            'condition' => [
      ...
      $this->add_responsive_control(
			'title_border_color', [
				...
				'label'		 => esc_html__( 'Title border color', 'inzox' ),
				'type'		 => Controls_Manager::COLOR,
				'selectors'	 => [
      ...
      $this->add_responsive_control(
			'title_boder_width',
			[
				'label' => esc_html__('Border width', 'inzox' ),
      ...
      $this->add_control(
			'title_boder_height',
			[
				'label' => esc_html__('Border height', 'inzox' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
      ...
      $this->add_responsive_control(
			'title_margin_bottom',
			[
				'label' => esc_html__('Border bottom', 'inzox' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%','px' ],
				'range' => [
					'%' => [
      ...
      $this->start_controls_section(
			'section_title_highlight_style', [
				'label'	 => esc_html__( 'Title highlight', 'inzox' ),
				'tab'	 => Controls_Manager::TAB_STYLE,
			]
      );
      ...
      $this->add_control(
			...
			[
				'label' => esc_html__( 'Icon typhography', 'inzox' ),
      ...
      $this->add_control(
			'title_icon_color', [
				'label'		 => esc_html__( 'Icon color', 'inzox' ),
				'type'		 => Controls_Manager::COLOR,
				'selectors'	 => [
					'{{WRAPPER}} .ts-section-title i' => 'color: {{VALUE}};',
