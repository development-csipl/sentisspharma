...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$uri = INZOX_THEME_URI . '/components/option-types/' . $this->get_type() . '/static';
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( INZOX_COMPONENTS . '/option-types/' . $this->get_type() . '/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'inzox' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'inzox' ),
					'hand'				 => esc_html__( 'Hand Icons', 'inzox' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'inzox' ),
					'gender'			 => esc_html__( 'Gender Icons', 'inzox' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'inzox' ),
					'payment'			 => esc_html__( 'Payment Icons', 'inzox' ),
					'currency'			 => esc_html__( 'Currency Icons', 'inzox' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'inzox' ),
					'directional'		 => esc_html__( 'Directional Icons', 'inzox' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'inzox' ),
					'brand'				 => esc_html__( 'Brand Icons', 'inzox' ),
					'medical'			 => esc_html__( 'Medical Icons', 'inzox' ),
					'inzox-icons'	 => esc_html__( 'Inzox Icons', 'inzox' ),
				),
				'icons'				 => array(
					...
					//inzox Icons
               'icon icon-title' => array('group' => 'inzox-icons'),
               'icon icon-feature_icon11' => array('group' => 'inzox-icons'),
               'icon icon-feature_icon1' => array('group' => 'inzox-icons'),
               'icon icon-feature_icon21' => array('group' => 'inzox-icons'),
               'icon icon-feature_icon2' => array('group' => 'inzox-icons'),
               'icon icon-feature_icon31' => array('group' => 'inzox-icons'),
               'icon icon-feature_icon3' => array('group' => 'inzox-icons'),
               'icon icon-funfact_icon1' => array('group' => 'inzox-icons'),
               'icon icon-funfact_icon2' => array('group' => 'inzox-icons'),
               'icon icon-funfact_icon3' => array('group' => 'inzox-icons'),
               'icon icon-menu_icon1' => array('group' => 'inzox-icons'),
               'icon icon-menu_icon2' => array('group' => 'inzox-icons'),
               'icon icon-menu_icon3' => array('group' => 'inzox-icons'),
               'icon icon-menu_icon4' => array('group' => 'inzox-icons'),
               'icon icon-menu_icon5' => array('group' => 'inzox-icons'),
               'icon icon-quote' => array('group' => 'inzox-icons'),
               'icon icon-About-2' => array('group' => 'inzox-icons'),
               'icon icon-About-3' => array('group' => 'inzox-icons'),
               'icon icon-About-4' => array('group' => 'inzox-icons'),
               'icon icon-About' => array('group' => 'inzox-icons'),
               'icon icon-Banner_current' => array('group' => 'inzox-icons'),
               'icon icon-Banner_factory-1' => array('group' => 'inzox-icons'),
               'icon icon-Banner_factory' => array('group' => 'inzox-icons'),
               'icon icon-Banner_pumpjack' => array('group' => 'inzox-icons'),
               'icon icon-Funfacts-2' => array('group' => 'inzox-icons'),
               'icon icon-Funfacts-3' => array('group' => 'inzox-icons'),
               'icon icon-Funfacts-4' => array('group' => 'inzox-icons'),
               'icon icon-Funfacts' => array('group' => 'inzox-icons'),
               'icon icon-mobile' => array('group' => 'inzox-icons'),
               'icon icon-laptop' => array('group' => 'inzox-icons'),
               'icon icon-desktop' => array('group' => 'inzox-icons'),
               'icon icon-tablet' => array('group' => 'inzox-icons'),
               'icon icon-phone' => array('group' => 'inzox-icons'),
               'icon icon-document' => array('group' => 'inzox-icons'),
               'icon icon-documents' => array('group' => 'inzox-icons'),
               'icon icon-search' => array('group' => 'inzox-icons'),
               'icon icon-clipboard' => array('group' => 'inzox-icons'),
               'icon icon-newspaper' => array('group' => 'inzox-icons'),
               'icon icon-notebook' => array('group' => 'inzox-icons'),
               'icon icon-book-open' => array('group' => 'inzox-icons'),
               'icon icon-browser' => array('group' => 'inzox-icons'),
               'icon icon-calendar' => array('group' => 'inzox-icons'),
               'icon icon-presentation' => array('group' => 'inzox-icons'),
               'icon icon-picture' => array('group' => 'inzox-icons'),
               'icon icon-pictures' => array('group' => 'inzox-icons'),
               'icon icon-video' => array('group' => 'inzox-icons'),
               'icon icon-camera' => array('group' => 'inzox-icons'),
               'icon icon-printer' => array('group' => 'inzox-icons'),
               'icon icon-toolbox' => array('group' => 'inzox-icons'),
               'icon icon-briefcase' => array('group' => 'inzox-icons'),
               'icon icon-wallet' => array('group' => 'inzox-icons'),
               'icon icon-gift' => array('group' => 'inzox-icons'),
               'icon icon-bargraph' => array('group' => 'inzox-icons'),
               'icon icon-grid' => array('group' => 'inzox-icons'),
               'icon icon-expand' => array('group' => 'inzox-icons'),
               'icon icon-focus' => array('group' => 'inzox-icons'),
               'icon icon-edit' => array('group' => 'inzox-icons'),
               'icon icon-adjustments' => array('group' => 'inzox-icons'),
               'icon icon-ribbon' => array('group' => 'inzox-icons'),
               'icon icon-hourglass' => array('group' => 'inzox-icons'),
               'icon icon-lock' => array('group' => 'inzox-icons'),
               'icon icon-megaphone' => array('group' => 'inzox-icons'),
               'icon icon-shield' => array('group' => 'inzox-icons'),
               'icon icon-trophy' => array('group' => 'inzox-icons'),
               'icon icon-flag' => array('group' => 'inzox-icons'),
               'icon icon-map' => array('group' => 'inzox-icons'),
               'icon icon-puzzle' => array('group' => 'inzox-icons'),
               'icon icon-basket' => array('group' => 'inzox-icons'),
               'icon icon-envelope' => array('group' => 'inzox-icons'),
               'icon icon-streetsign' => array('group' => 'inzox-icons'),
               'icon icon-telescope' => array('group' => 'inzox-icons'),
               'icon icon-gears' => array('group' => 'inzox-icons'),
               'icon icon-key' => array('group' => 'inzox-icons'),
               'icon icon-paperclip' => array('group' => 'inzox-icons'),
               'icon icon-attachment' => array('group' => 'inzox-icons'),
               'icon icon-pricetags' => array('group' => 'inzox-icons'),
               'icon icon-lightbulb' => array('group' => 'inzox-icons'),
               'icon icon-layers' => array('group' => 'inzox-icons'),
               'icon icon-pencil' => array('group' => 'inzox-icons'),
               'icon icon-tools' => array('group' => 'inzox-icons'),
               'icon icon-tools-2' => array('group' => 'inzox-icons'),
               'icon icon-scissors' => array('group' => 'inzox-icons'),
               'icon icon-paintbrush' => array('group' => 'inzox-icons'),
               'icon icon-magnifying-glass' => array('group' => 'inzox-icons'),
               'icon icon-circle-compass' => array('group' => 'inzox-icons'),
               'icon icon-linegraph' => array('group' => 'inzox-icons'),
               'icon icon-mic' => array('group' => 'inzox-icons'),
               'icon icon-strategy' => array('group' => 'inzox-icons'),
               'icon icon-beaker' => array('group' => 'inzox-icons'),
               'icon icon-caution' => array('group' => 'inzox-icons'),
               'icon icon-recycle' => array('group' => 'inzox-icons'),
               'icon icon-anchor' => array('group' => 'inzox-icons'),
               'icon icon-profile-male' => array('group' => 'inzox-icons'),
               'icon icon-profile-female' => array('group' => 'inzox-icons'),
               'icon icon-bike' => array('group' => 'inzox-icons'),
               'icon icon-wine' => array('group' => 'inzox-icons'),
               'icon icon-hotairballoon' => array('group' => 'inzox-icons'),
               'icon icon-globe' => array('group' => 'inzox-icons'),
               'icon icon-genius' => array('group' => 'inzox-icons'),
               'icon icon-map-pin' => array('group' => 'inzox-icons'),
               'icon icon-dial' => array('group' => 'inzox-icons'),
               'icon icon-chat' => array('group' => 'inzox-icons'),
               'icon icon-heart' => array('group' => 'inzox-icons'),
               'icon icon-cloud' => array('group' => 'inzox-icons'),
               'icon icon-upload' => array('group' => 'inzox-icons'),
               'icon icon-download' => array('group' => 'inzox-icons'),
               'icon icon-target' => array('group' => 'inzox-icons'),
               'icon icon-hazardous' => array('group' => 'inzox-icons'),
               'icon icon-piechart' => array('group' => 'inzox-icons'),
               'icon icon-speedometer' => array('group' => 'inzox-icons'),
               'icon icon-global' => array('group' => 'inzox-icons'),
               'icon icon-compass' => array('group' => 'inzox-icons'),
               'icon icon-lifesaver' => array('group' => 'inzox-icons'),
               'icon icon-clock' => array('group' => 'inzox-icons'),
               'icon icon-aperture' => array('group' => 'inzox-icons'),
               'icon icon-quote1' => array('group' => 'inzox-icons'),
               'icon icon-scope' => array('group' => 'inzox-icons'),
               'icon icon-alarmclock' => array('group' => 'inzox-icons'),
               'icon icon-refresh' => array('group' => 'inzox-icons'),
               'icon icon-happy' => array('group' => 'inzox-icons'),
               'icon icon-sad' => array('group' => 'inzox-icons'),
               'icon icon-facebook' => array('group' => 'inzox-icons'),
               'icon icon-twitter' => array('group' => 'inzox-icons'),
               'icon icon-googleplus' => array('group' => 'inzox-icons'),
               'icon icon-rss' => array('group' => 'inzox-icons'),
               'icon icon-tumblr' => array('group' => 'inzox-icons'),
               'icon icon-linkedin' => array('group' => 'inzox-icons'),
               'icon icon-dribbble' => array('group' => 'inzox-icons'),
               'icon icon-home' => array('group' => 'inzox-icons'),
               'icon icon-apartment' => array('group' => 'inzox-icons'),
               'icon icon-pencil1' => array('group' => 'inzox-icons'),
               'icon icon-magic-wand' => array('group' => 'inzox-icons'),
               'icon icon-drop' => array('group' => 'inzox-icons'),
               'icon icon-lighter' => array('group' => 'inzox-icons'),
               'icon icon-poop' => array('group' => 'inzox-icons'),
               'icon icon-sun' => array('group' => 'inzox-icons'),
               'icon icon-moon' => array('group' => 'inzox-icons'),
               'icon icon-cloud1' => array('group' => 'inzox-icons'),
               'icon icon-cloud-upload' => array('group' => 'inzox-icons'),
               'icon icon-cloud-download' => array('group' => 'inzox-icons'),
               'icon icon-cloud-sync' => array('group' => 'inzox-icons'),
               'icon icon-cloud-check' => array('group' => 'inzox-icons'),
               'icon icon-database' => array('group' => 'inzox-icons'),
               'icon icon-lock1' => array('group' => 'inzox-icons'),
               'icon icon-cog' => array('group' => 'inzox-icons'),
               'icon icon-trash' => array('group' => 'inzox-icons'),
               'icon icon-dice' => array('group' => 'inzox-icons'),
               'icon icon-heart1' => array('group' => 'inzox-icons'),
               'icon icon-star' => array('group' => 'inzox-icons'),
               'icon icon-star-half' => array('group' => 'inzox-icons'),
               'icon icon-star-empty' => array('group' => 'inzox-icons'),
               'icon icon-flag1' => array('group' => 'inzox-icons'),
               'icon icon-envelope1' => array('group' => 'inzox-icons'),
               'icon icon-paperclip1' => array('group' => 'inzox-icons'),
               'icon icon-inbox' => array('group' => 'inzox-icons'),
               'icon icon-eye' => array('group' => 'inzox-icons'),
               'icon icon-printer1' => array('group' => 'inzox-icons'),
               'icon icon-file-empty' => array('group' => 'inzox-icons'),
               'icon icon-file-add' => array('group' => 'inzox-icons'),
               'icon icon-enter' => array('group' => 'inzox-icons'),
               'icon icon-exit' => array('group' => 'inzox-icons'),
               'icon icon-graduation-hat' => array('group' => 'inzox-icons'),
               'icon icon-license' => array('group' => 'inzox-icons'),
               'icon icon-music-note' => array('group' => 'inzox-icons'),
               'icon icon-film-play' => array('group' => 'inzox-icons'),
               'icon icon-camera-video' => array('group' => 'inzox-icons'),
               'icon icon-camera1' => array('group' => 'inzox-icons'),
               'icon icon-picture1' => array('group' => 'inzox-icons'),
               'icon icon-book' => array('group' => 'inzox-icons'),
               'icon icon-bookmark' => array('group' => 'inzox-icons'),
               'icon icon-user' => array('group' => 'inzox-icons'),
               'icon icon-users' => array('group' => 'inzox-icons'),
               'icon icon-shirt' => array('group' => 'inzox-icons'),
               'icon icon-store' => array('group' => 'inzox-icons'),
               'icon icon-cart' => array('group' => 'inzox-icons'),
               'icon icon-tag' => array('group' => 'inzox-icons'),
               'icon icon-phone-handset' => array('group' => 'inzox-icons'),
               'icon icon-phone1' => array('group' => 'inzox-icons'),
               'icon icon-pushpin' => array('group' => 'inzox-icons'),
               'icon icon-map-marker' => array('group' => 'inzox-icons'),
               'icon icon-map1' => array('group' => 'inzox-icons'),
               'icon icon-location' => array('group' => 'inzox-icons'),
               'icon icon-calendar-full' => array('group' => 'inzox-icons'),
               'icon icon-keyboard' => array('group' => 'inzox-icons'),
               'icon icon-spell-check' => array('group' => 'inzox-icons'),
               'icon icon-screen' => array('group' => 'inzox-icons'),
               'icon icon-smartphone' => array('group' => 'inzox-icons'),
               'icon icon-tablet1' => array('group' => 'inzox-icons'),
               'icon icon-laptop1' => array('group' => 'inzox-icons'),
               'icon icon-laptop-phone' => array('group' => 'inzox-icons'),
               'icon icon-power-switch' => array('group' => 'inzox-icons'),
               'icon icon-bubble' => array('group' => 'inzox-icons'),
               'icon icon-heart-pulse' => array('group' => 'inzox-icons'),
               'icon icon-construction' => array('group' => 'inzox-icons'),
               'icon icon-pie-chart' => array('group' => 'inzox-icons'),
               'icon icon-chart-bars' => array('group' => 'inzox-icons'),
               'icon icon-gift1' => array('group' => 'inzox-icons'),
               'icon icon-diamond' => array('group' => 'inzox-icons'),
               'icon icon-dinner' => array('group' => 'inzox-icons'),
               'icon icon-coffee-cup' => array('group' => 'inzox-icons'),
               'icon icon-leaf' => array('group' => 'inzox-icons'),
               'icon icon-paw' => array('group' => 'inzox-icons'),
               'icon icon-rocket' => array('group' => 'inzox-icons'),
               'icon icon-briefcase1' => array('group' => 'inzox-icons'),
               'icon icon-bus' => array('group' => 'inzox-icons'),
               'icon icon-car' => array('group' => 'inzox-icons'),
               'icon icon-train' => array('group' => 'inzox-icons'),
               'icon icon-bicycle' => array('group' => 'inzox-icons'),
               'icon icon-wheelchair' => array('group' => 'inzox-icons'),
               'icon icon-select' => array('group' => 'inzox-icons'),
               'icon icon-earth' => array('group' => 'inzox-icons'),
               'icon icon-smile' => array('group' => 'inzox-icons'),
               'icon icon-sad1' => array('group' => 'inzox-icons'),
               'icon icon-neutral' => array('group' => 'inzox-icons'),
               'icon icon-mustache' => array('group' => 'inzox-icons'),
               'icon icon-alarm' => array('group' => 'inzox-icons'),
               'icon icon-bullhorn' => array('group' => 'inzox-icons'),
               'icon icon-volume-high' => array('group' => 'inzox-icons'),
               'icon icon-volume-medium' => array('group' => 'inzox-icons'),
               'icon icon-volume-low' => array('group' => 'inzox-icons'),
               'icon icon-volume' => array('group' => 'inzox-icons'),
               'icon icon-mic1' => array('group' => 'inzox-icons'),
               'icon icon-hourglass1' => array('group' => 'inzox-icons'),
               'icon icon-undo' => array('group' => 'inzox-icons'),
               'icon icon-redo' => array('group' => 'inzox-icons'),
               'icon icon-sync' => array('group' => 'inzox-icons'),
               'icon icon-history' => array('group' => 'inzox-icons'),
               'icon icon-clock1' => array('group' => 'inzox-icons'),
               'icon icon-download1' => array('group' => 'inzox-icons'),
               'icon icon-upload1' => array('group' => 'inzox-icons'),
               'icon icon-enter-down' => array('group' => 'inzox-icons'),
               'icon icon-exit-up' => array('group' => 'inzox-icons'),
               'icon icon-bug' => array('group' => 'inzox-icons'),
               'icon icon-code' => array('group' => 'inzox-icons'),
               'icon icon-link' => array('group' => 'inzox-icons'),
               'icon icon-unlink' => array('group' => 'inzox-icons'),
               'icon icon-thumbs-up' => array('group' => 'inzox-icons'),
               'icon icon-thumbs-down' => array('group' => 'inzox-icons'),
               'icon icon-magnifier' => array('group' => 'inzox-icons'),
               'icon icon-cross' => array('group' => 'inzox-icons'),
               'icon icon-menu' => array('group' => 'inzox-icons'),
               'icon icon-list' => array('group' => 'inzox-icons'),
               'icon icon-chevron-up' => array('group' => 'inzox-icons'),
               'icon icon-chevron-down' => array('group' => 'inzox-icons'),
               'icon icon-chevron-left' => array('group' => 'inzox-icons'),
               'icon icon-chevron-right' => array('group' => 'inzox-icons'),
               'icon icon-arrow-up' => array('group' => 'inzox-icons'),
               'icon icon-arrow-down' => array('group' => 'inzox-icons'),
               'icon icon-arrow-left' => array('group' => 'inzox-icons'),
               'icon icon-arrow-right' => array('group' => 'inzox-icons'),
               'icon icon-move' => array('group' => 'inzox-icons'),
               'icon icon-warning' => array('group' => 'inzox-icons'),
               'icon icon-question-circle' => array('group' => 'inzox-icons'),
               'icon icon-menu-circle' => array('group' => 'inzox-icons'),
               'icon icon-checkmark-circle' => array('group' => 'inzox-icons'),
               'icon icon-cross-circle' => array('group' => 'inzox-icons'),
               'icon icon-plus-circle' => array('group' => 'inzox-icons'),
               'icon icon-circle-minus' => array('group' => 'inzox-icons'),
               'icon icon-arrow-up-circle' => array('group' => 'inzox-icons'),
               'icon icon-arrow-down-circle' => array('group' => 'inzox-icons'),
               'icon icon-arrow-left-circle' => array('group' => 'inzox-icons'),
               'icon icon-arrow-right-circle' => array('group' => 'inzox-icons'),
               'icon icon-chevron-up-circle' => array('group' => 'inzox-icons'),
               'icon icon-chevron-down-circle' => array('group' => 'inzox-icons'),
               'icon icon-chevron-left-circle' => array('group' => 'inzox-icons'),
               'icon icon-chevron-right-circle' => array('group' => 'inzox-icons'),
               'icon icon-crop' => array('group' => 'inzox-icons'),
               'icon icon-frame-expand' => array('group' => 'inzox-icons'),
               'icon icon-frame-contract' => array('group' => 'inzox-icons'),
               'icon icon-layers1' => array('group' => 'inzox-icons'),
               'icon icon-funnel' => array('group' => 'inzox-icons'),
               'icon icon-text-format' => array('group' => 'inzox-icons'),
               'icon icon-text-size' => array('group' => 'inzox-icons'),
               'icon icon-bold' => array('group' => 'inzox-icons'),
               'icon icon-italic' => array('group' => 'inzox-icons'),
               'icon icon-underline' => array('group' => 'inzox-icons'),
               'icon icon-strikethrough' => array('group' => 'inzox-icons'),
               'icon icon-highlight' => array('group' => 'inzox-icons'),
               'icon icon-text-align-left' => array('group' => 'inzox-icons'),
               'icon icon-text-align-center' => array('group' => 'inzox-icons'),
               'icon icon-text-align-right' => array('group' => 'inzox-icons'),
               'icon icon-text-align-justify' => array('group' => 'inzox-icons'),
               'icon icon-line-spacing' => array('group' => 'inzox-icons'),
               'icon icon-indent-increase' => array('group' => 'inzox-icons'),
               'icon icon-indent-decrease' => array('group' => 'inzox-icons'),
               'icon icon-page-break' => array('group' => 'inzox-icons'),
               'icon icon-hand' => array('group' => 'inzox-icons'),
               'icon icon-pointer-up' => array('group' => 'inzox-icons'),
               'icon icon-pointer-right' => array('group' => 'inzox-icons'),
               'icon icon-pointer-down' => array('group' => 'inzox-icons'),
               'icon icon-pointer-left' => array('group' => 'inzox-icons'),
               'icon icon-vplay' => array('group' => 'inzox-icons'),
               'icon icon-newsletter' => array('group' => 'inzox-icons'),
               'icon icon-coins-2' => array('group' => 'inzox-icons'),
               'icon icon-commerce-2' => array('group' => 'inzox-icons'),
               'icon icon-monitor' => array('group' => 'inzox-icons'),
               'icon icon-graphic-3' => array('group' => 'inzox-icons'),
               'icon icon-business' => array('group' => 'inzox-icons'),
               'icon icon-graphic-2' => array('group' => 'inzox-icons'),
               'icon icon-commerce-1' => array('group' => 'inzox-icons'),
               'icon icon-hammer' => array('group' => 'inzox-icons'),
               'icon icon-graphic-1' => array('group' => 'inzox-icons'),
               'icon icon-graphic' => array('group' => 'inzox-icons'),
               'icon icon-justice-1' => array('group' => 'inzox-icons'),
               'icon icon-line' => array('group' => 'inzox-icons'),
               'icon icon-money-3' => array('group' => 'inzox-icons'),
               'icon icon-chart' => array('group' => 'inzox-icons'),
               'icon icon-commerce' => array('group' => 'inzox-icons'),
               'icon icon-agenda' => array('group' => 'inzox-icons'),
               'icon icon-money-2' => array('group' => 'inzox-icons'),
               'icon icon-justice' => array('group' => 'inzox-icons'),
               'icon icon-money-1' => array('group' => 'inzox-icons'),
               'icon icon-money' => array('group' => 'inzox-icons'),
               'icon icon-technology' => array('group' => 'inzox-icons'),
               'icon icon-coins-1' => array('group' => 'inzox-icons'),
               'icon icon-coins' => array('group' => 'inzox-icons'),
               'icon icon-left-arrow' => array('group' => 'inzox-icons'),
               'icon icon-bank' => array('group' => 'inzox-icons'),
               'icon icon-calculator' => array('group' => 'inzox-icons'),
               'icon icon-chart1' => array('group' => 'inzox-icons'),
               'icon icon-chart2' => array('group' => 'inzox-icons'),
               'icon icon-checked' => array('group' => 'inzox-icons'),
               'icon icon-clock2' => array('group' => 'inzox-icons'),
               'icon icon-comment' => array('group' => 'inzox-icons'),
               'icon icon-comments' => array('group' => 'inzox-icons'),
               'icon icon-consult' => array('group' => 'inzox-icons'),
               'icon icon-consut2' => array('group' => 'inzox-icons'),
               'icon icon-deal' => array('group' => 'inzox-icons'),
               'icon icon-download2' => array('group' => 'inzox-icons'),
               'icon icon-envelope2' => array('group' => 'inzox-icons'),
               'icon icon-euro' => array('group' => 'inzox-icons'),
               'icon icon-folder' => array('group' => 'inzox-icons'),
               'icon icon-invest' => array('group' => 'inzox-icons'),
               'icon icon-loan' => array('group' => 'inzox-icons'),
               'icon icon-map-marker1' => array('group' => 'inzox-icons'),
               'icon icon-mutual-fund' => array('group' => 'inzox-icons'),
               'icon icon-percent' => array('group' => 'inzox-icons'),
               'icon icon-phone2' => array('group' => 'inzox-icons'),
               'icon icon-pie-chart1' => array('group' => 'inzox-icons'),
               'icon icon-play' => array('group' => 'inzox-icons'),
               'icon icon-left-arrow2' => array('group' => 'inzox-icons'),
               'icon icon-savings' => array('group' => 'inzox-icons'),
               'icon icon-search1' => array('group' => 'inzox-icons'),
               'icon icon-tag1' => array('group' => 'inzox-icons'),
               'icon icon-tags' => array('group' => 'inzox-icons'),
               'icon icon-tax' => array('group' => 'inzox-icons'),
               'icon icon-quote11' => array('group' => 'inzox-icons'),
               'icon icon-right-arrow2' => array('group' => 'inzox-icons'),
				),
			),
		);
	}
