...
if ( defined( 'FW' ) ) { 
   $inzox_banner_settings         = inzox_option('service_banner_setting');
   ...
   }elseif( is_array($inzox_banner_settings['banner_service_image']) && $inzox_banner_settings['banner_service_image']['url'] != ''){
         $inzox_banner_image = $inzox_banner_settings['banner_service_image']['url'];
   }else{
   ...
   }elseif($inzox_banner_settings['banner_service_title'] != ''){
      $inzox_banner_title = $inzox_banner_settings['banner_service_title'];
   }else{
      $inzox_banner_title   = get_the_title();
   }

   //show
   $inzox_show = (isset($inzox_banner_settings['service_show_banner'])) ? $inzox_banner_settings['service_show_banner'] : 'yes'; 
    
   //breadcumb 
   $inzox_show_breadcrumb =  (isset($inzox_banner_settings['service_show_breadcrumb'])) ? $inzox_banner_settings['service_show_breadcrumb'] : 'yes';
