<?php 
   ...
   $inzox_banner_title    = '';
   $inzox_banner_desc     = '';
   $inzox_banner_style    = 'full';
   $inzox_header_style    = 'standard';

   if ( defined( 'FW' ) ) { 

 
      $inzox_banner_settings          = inzox_option('page_banner_setting'); 
      ...
      }elseif($inzox_banner_settings['banner_page_title'] != ''){
         $inzox_banner_title = $inzox_banner_settings['banner_page_title'];
      }else{
      ...
      // description
      if(inzox_meta_option( get_the_ID(), 'header_desc' ) != ''){
         $inzox_banner_desc = inzox_meta_option( get_the_ID(), 'header_desc' );
      }
      elseif($inzox_banner_settings['banner_page_desc'] != ''){
         $inzox_banner_desc = $inzox_banner_settings['banner_page_desc'];
      }
      else {
         $inzox_banner_desc = esc_html__('Inzox expertise, attentiveness to new trends, commitment to partner','inzox');
      }

      //image
      if(is_array($inzox_banner_image) && $inzox_banner_image['url'] != '' ){
         $inzox_banner_image = $inzox_banner_image['url'];
      }elseif( is_array($inzox_banner_settings['banner_page_image']) && $inzox_banner_settings['banner_page_image']['url'] != ''){
            $inzox_banner_image = $inzox_banner_settings['banner_page_image']['url'];
      }else{
         $inzox_banner_image = INZOX_IMG.'/banner/banner.jpg';
      }
      
      $inzox_show = (isset($inzox_banner_settings['page_show_banner'])) ? $inzox_banner_settings['page_show_banner'] : 'yes'; 
      // breadcumb
      $inzox_show_breadcrumb =  (isset($inzox_banner_settings['page_show_breadcrumb'])) ? $inzox_banner_settings['page_show_breadcrumb'] : 'yes';
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="banner-content">
                           ...
                           <p>
                              <?php echo esc_html($inzox_banner_desc); ?>
                           </p>
                        </div>
