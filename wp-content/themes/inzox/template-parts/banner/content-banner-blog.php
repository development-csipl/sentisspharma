...
if ( defined( 'FW' ) ) { 
   $inzox_banner_settings         = inzox_option('blog_banner_setting'); 
   $inzox_banner_style            = inzox_option('sub_page_banner_style');
   $inzox_header_style            = inzox_option('header_layout_style', 'standard');
  
   //image
   $inzox_banner_image = ( is_array($inzox_banner_settings['banner_blog_image']) && $inzox_banner_settings['banner_blog_image']['url'] != '') ? 
                        $inzox_banner_settings['banner_blog_image']['url'] : INZOX_IMG.'/banner/banner.jpg';

   //title 
   $inzox_banner_title = (isset($inzox_banner_settings['banner_blog_title']) && $inzox_banner_settings['banner_blog_title'] != '') ? 
                        $inzox_banner_settings['banner_blog_title'] : get_bloginfo( 'name' );
   //show
   $inzox_show = (isset($inzox_banner_settings['blog_show_banner'])) ? $inzox_banner_settings['blog_show_banner'] : 'yes'; 
   // banner overlay
   $inzox_show = (isset($inzox_banner_settings['blog_show_banner'])) ? $inzox_banner_settings['blog_show_banner'] : 'yes'; 
    
   //breadcumb 
   $inzox_show_breadcrumb =  (isset($inzox_banner_settings['blog_show_breadcrumb'])) ? $inzox_banner_settings['blog_show_breadcrumb'] : 'yes';

 }else{
     //default
   $inzox_banner_image             = '';
   $inzox_banner_title             = get_bloginfo( 'name' );
   $inzox_show                     = 'yes';
