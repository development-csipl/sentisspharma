    ...
    public function register_controls($control, $args)
    {
        ...
        */
        $control->add_control(
            ...
            [
                'label' => esc_html__('CSS Animation', 'inzox-essential'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'inzox-essential'),
                'render_type' => 'ui',
                'label_off' => esc_html__('Off', 'inzox-essential'),
                'condition' => [
        ...
        $control->add_control(
            ...
            [
                'label' => esc_html__( 'Animation speed', 'inzox-essential' ),
        ...
        */
        ...
        $control->add_control(
            ...
            [
                'render_type' => 'none',
                'frontend_available' => true,
                'label' => esc_html__('Disable animation in editor ', 'inzox-essential'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'on',
                'label_on' => esc_html__('On', 'inzox-essential'),
                'label_off' => esc_html__('Off', 'inzox-essential'),
