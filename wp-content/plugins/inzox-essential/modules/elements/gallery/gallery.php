...
class Elementskit_Widget_Gallery extends Widget_Base
{
    ...
    public function get_title() {
        return esc_html__( 'Inzox Gallery', 'inzox-essential' );
    }

    public function get_icon() {
        return 'ekit ekit-image-gallery';
    }

    public function get_categories() {
        return [ 'inzox-elements','elementskit' ];
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Gallery Content', 'inzox-essential' ),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Filter Label', 'inzox-essential' ),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Add Images', 'inzox-essential' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Layout', 'inzox-essential' ),
            ]
        );
        ...
        $this->add_control(
            'ekit_gallery_style',
            [
                'label' => esc_html__( 'Style', 'inzox-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'grid',
                'options' => [
                    'grid' => esc_html__( 'Grid', 'inzox-essential' ),
                    'masonry' => esc_html__( 'Masonry', 'inzox-essential' ),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Columns', 'inzox-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => '3',
                'tablet_default' => '2',
                'mobile_default' => '1',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Image Aspect Ratio', 'inzox-essential' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Settings', 'inzox-essential' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( '"All" Filter Label', 'inzox-essential' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'All', 'inzox-essential' ),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label'    => esc_html__( 'Content Alignment', 'inzox-essential' ),
                'type'     => Controls_Manager::CHOOSE,
                'options'  => [
                    'left'   => [
                        'title' => esc_html__( 'Left', 'inzox-essential' ),
                        'icon'  => 'fa fa-align-left',
                    ],
                    'center' => [
                        'title' => esc_html__( 'Center', 'inzox-essential' ),
                        'icon'  => 'fa fa-align-center',
                    ],
                    'right'  => [
                        'title' => esc_html__( 'Right', 'inzox-essential' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Alignment', 'inzox-essential' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'top' => [
						'title' => esc_html__( 'Top', 'inzox-essential' ),
					...
					'bottom' => [
						'title' => esc_html__( 'Bottom', 'inzox-essential' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Caption', 'inzox-essential' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Description', 'inzox-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'inzox-essential' ),
				'label_off' => esc_html__( 'Hide', 'inzox-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Filter Label', 'inzox-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'inzox-essential' ),
				'label_off' => esc_html__( 'Hide', 'inzox-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Lightbox', 'inzox-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'inzox-essential' ),
				'label_off' => esc_html__( 'Hide', 'inzox-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Lightbox Icon', 'inzox-essential' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Image Slideshow', 'inzox-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'True', 'inzox-essential' ),
				'label_off' => esc_html__( 'Flase', 'inzox-essential' ),
				'return_value' => 'yes',
                'default' => 'yes',
                'condition' => [
                    'ekit_gallery_open_lightbox' => 'yes'
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Ordering', 'inzox-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => esc_html__( 'Default', 'inzox-essential' ),
                    'random' => esc_html__( 'Random', 'inzox-essential' ),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Columns Gap', 'inzox-essential' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 5,
                    'unit' => 'px',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Rows Gap', 'inzox-essential' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Content Padding', 'inzox-essential' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Thumbnails', 'inzox-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Border Radius', 'inzox-essential' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Normal', 'inzox-essential' ),
            ]
        );
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Box Shadow', 'inzox-essential' ),
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Border', 'inzox-essential' ),
				'selector' => '{{WRAPPER}} .elementskit-single-portfolio-item',
			]
		);
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Hover', 'inzox-essential' ),
            ]
        );
        ...
        $ekit_image_filters = [
            ...
            'opacity' => esc_html__( 'Opacity', 'inzox-essential' ),
            'scale' => esc_html__( 'Scale', 'inzox-essential' ),
            'rotate' => esc_html__( 'Rotate', 'inzox-essential' ),
            'blur' => esc_html__( 'Blur', 'inzox-essential' ),
            'gray-scale' => esc_html__( 'Gray Scale', 'inzox-essential' ),
        ];

        $this->add_control(
            'ekit_gallery_thumbnail_filter',
            [
                'label' => esc_html__( 'Image Filter', 'inzox-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'normal',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Scale', 'inzox-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Gray Scale', 'inzox-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Tilt', 'inzox-essential' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Axis', 'inzox-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'both',
                'options' => [
                    'both' => esc_html__( 'Both', 'inzox-essential' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Amount', 'inzox-essential' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Depth', 'inzox-essential' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Glare', 'inzox-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'inzox-essential' ),
				'label_off' => esc_html__( 'Hide', 'inzox-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Perspective', 'inzox-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Caption', 'inzox-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Typography', 'inzox-essential' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Margin', 'inzox-essential' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Padding', 'inzox-essential' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Background Color', 'inzox-essential' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Text Color', 'inzox-essential' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Text Shadow', 'inzox-essential' ),
                'selector' => '{{WRAPPER}} .elementskit-single-portfolio-item  .elementskit-gallery-title',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Border Color', 'inzox-essential' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Description', 'inzox-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Label', 'inzox-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Link Icon', 'inzox-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'ekit_gallery_open_lightbox' => 'yes',
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Size', 'inzox-essential' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 5,
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Size', 'inzox-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Font Size', 'inzox-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Overlay', 'inzox-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $ekit_image_blend_mode = [
            'normal' => esc_html__( 'Normal', 'inzox-essential' ),
            'multiply' => esc_html__( 'Multiply', 'inzox-essential' ),
            'screen' => esc_html__( 'Screen', 'inzox-essential' ),
            'overlay' => esc_html__( 'Overlay', 'inzox-essential' ),
            'darken' => esc_html__( 'Darken', 'inzox-essential' ),
            'lighten' => esc_html__( 'Lighten', 'inzox-essential' ),
            'color-dodge' => esc_html__( 'Color-dodge', 'inzox-essential' ),
            'color-burn' => esc_html__( 'Color-burn', 'inzox-essential' ),
            'difference' => esc_html__( 'Difference', 'inzox-essential' ),
            'exclusion' => esc_html__( 'Exclusion', 'inzox-essential' ),
            'hue' => esc_html__( 'hue', 'ElementsKit' ),
            'saturation' => esc_html__( 'Saturation', 'inzox-essential' ),
            'color' => esc_html__( 'Color', 'inzox-essential' ),
            'luminosity' => esc_html__( 'Luminosity', 'inzox-essential' ),
        ];

        $this->add_control(
			'ekit_gallery_show_image_overlay',
			[
				'label' => esc_html__( 'Show Overlay', 'inzox-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'inzox-essential' ),
				'label_off' => esc_html__( 'Hide', 'inzox-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Blend Mode', 'inzox-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'normal',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Filter', 'inzox-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Filter Style', 'inzox-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default'  => esc_html__( 'Default', 'inzox-essential' ),
					'style_one' => esc_html__( 'Style One', 'inzox-essential' ),
					'style_two' => esc_html__( 'Style Two', 'inzox-essential' ),
					'style_three' => esc_html__( 'Style Three', 'inzox-essential' ),
					'style_four' => esc_html__( 'Style Four', 'inzox-essential' ),
					'style_five' => esc_html__( 'Style Five', 'inzox-essential' ),
					'style_six' => esc_html__( 'Style Six', 'inzox-essential' ),
					'style_seven' => esc_html__( 'Style Seven', 'inzox-essential' ),
					'style_eight' => esc_html__( 'Style Eight', 'inzox-essential' ),
					'style_nine' => esc_html__( 'Style Nine', 'inzox-essential' ),
					'style_ten' => esc_html__( 'Style Ten', 'inzox-essential' ),
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Nav Fill', 'inzox-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'inzox-essential' ),
				'label_off' => esc_html__( 'No', 'inzox-essential' ),
				'return_value' => 'yes',
				'default' => 'no',
			]
		);
        ...
        $this->add_responsive_control(
            ...
            [
                'label'    => esc_html__( 'Filter Items Alignment', 'inzox-essential' ),
                'type'     => Controls_Manager::CHOOSE,
                'options'  => [
                    'flex-start'   => [
                        'title' => esc_html__( 'Left', 'inzox-essential' ),
                    ...
                    'space-between'  => [
                        'title' => esc_html__( 'Justify', 'inzox-essential' ),
        ...
        $this->add_control(
            ...
            [
                'label'    => esc_html__( 'Filter Alignment', 'inzox-essential' ),
                'type'     => Controls_Manager::CHOOSE,
                'options'  => [
                    'left'   => [
                        'title' => esc_html__( 'Left', 'inzox-essential' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Caret', 'inzox-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'inzox-essential' ),
				'label_off' => esc_html__( 'Hide', 'inzox-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Height', 'inzox-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Top', 'inzox-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Background', 'inzox-essential' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Bottom', 'inzox-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'%' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Divider', 'inzox-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'inzox-essential' ),
				'label_off' => esc_html__( 'Hide', 'inzox-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Left', 'inzox-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Nav Bottom Spacing', 'inzox-essential' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Active', 'inzox-essential' ),
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container Style', 'inzox-essential' ),
