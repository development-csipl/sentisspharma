<?php
/*
* Plugin Name: Inzox Essentials
* License - GNU/GPL V2 or Later
* Description: This is a required plugin for Inzox theme.
* Version: 1.3
* text domain: inzox-essential
*/
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
...
// Add language
add_action( 'init', 'inzox_language_load' );
function inzox_language_load(){
    $plugin_dir = basename(dirname(__FILE__))."/languages/";
    load_plugin_textdomain( 'inzox-essential', false, $plugin_dir );
}

// main class
class Inzox_Essentials_Includes {
	...
	public static function include_widget( $widget_dir ) {
		...
		register_widget( 'Inzox_' . self::dirname_to_classname( $widget_dir ) );
	}
	...
	public static function _action_init() {
        ...
        self::include_isolated( self::get_path('/settings/controls.php') );
    }
}

Inzox_Essentials_Includes::init();
