...
class Inzox_Footer_Address extends WP_Widget
{
    function __construct() {
        $widget_opt = array(
            'classname'     => 'inzox-footer-address',
            'description'   => esc_html__('Inzox footer address','inzox-essential')
        );
        
        parent::__construct('xs-footer-address', esc_html__('Inzox footer address', 'inzox-essential'), $widget_opt);
    }
    
    function widget( $args, $instance ){
        
        echo delicios_return($args['before_widget']);
        if ( !empty( $instance[ 'title' ] ) ) {

            echo delicios_return($args[ 'before_title' ]) . apply_filters( 'widget_title', $instance[ 'title' ] ) . delicios_return($args[ 'after_title' ]);
        }
        ...
        <div class="media xs-footer-info-and-payment">
            ...
            <div class="media-body">
                ...
                <?php endif; ?>
                <?php if($map_btn != ''): ?>
                    <a href="https://maps.google.com/maps?<?php echo delicios_return($query_string);?>" class="xs-map-popup btn btn-primary">
                        <?php if($map_icon != ''): ?>
    ...
    function form($instance){
    	if(isset($instance['title'])){
            ...
            $title = esc_html__( 'Footer address', 'inzox-essential' );
        }
        if(isset($instance['message'])){
            $message = $instance['message'];
        }else{
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'message' )); ?>"><?php esc_html_e( 'Message' , 'inzox-essential' ).':'; ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'address' )); ?>"><?php esc_html_e( 'Address' , 'inzox-essential' ).':'; ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'mobile' )); ?>"><?php esc_html_e( 'Mobile' , 'inzox-essential' ).':'; ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'media_icon' )); ?>"><?php esc_html_e( 'Media icon' , 'inzox-essential' ).':'; ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'map_icon' )); ?>"><?php esc_html_e( 'Map icon' , 'inzox-essential' ).':'; ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'map_btn' )); ?>"><?php esc_html_e( 'Map button' , 'inzox-essential' ).':'; ?></label>
